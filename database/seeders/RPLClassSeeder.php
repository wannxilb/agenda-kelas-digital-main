...
class RPLClassSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $kelas = [
            ['grade' => 'X',   'prefix' => 'PPLG', 'qty' => 2],
            ['grade' => 'XI',  'prefix' => 'RPL',  'qty' => 2],
            ['grade' => 'XII', 'prefix' => 'RPL',  'qty' => 2],
        ];
        ...
        $this->command->info('Kelas jurusan Rekayasa Perangkat Lunak berhasil dibuat.');
    }
}
