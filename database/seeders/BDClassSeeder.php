...
class BDClassSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $kelas = [
            ['grade' => 'X',   'prefix' => 'PM', 'qty' => 3],
            ['grade' => 'XI',  'prefix' => 'BD', 'qty' => 3],
            ['grade' => 'XII', 'prefix' => 'BD', 'qty' => 3],
        ];
        ...
        $this->command->info('Kelas jurusan Bisnis Digital berhasil dibuat.');
    }
}
