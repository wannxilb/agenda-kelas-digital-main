...
class DPBClassSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $kelas = [
            ['grade' => 'X',   'prefix' => 'BS', 'qty' => 2],
            ['grade' => 'XI',  'prefix' => 'DPB', 'qty' => 2],
            ['grade' => 'XII', 'prefix' => 'DPB', 'qty' => 2],
        ];
        ...
        foreach ($kelas as $k) {
            ...
            for ($i = 1; $i <= $k['qty']; $i++) {
                ...
                Classes::firstOrCreate(
                    ...
                    [
                        'major' => 'Desain dan Produksi Busana',
                        'grade_level' => $k['grade'],
        ...
        $this->command->info('Kelas jurusan Desain dan Produksi Busana berhasil dibuat.');
    }
}
