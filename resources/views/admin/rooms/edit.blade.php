...
<div class="max-w-3xl mx-auto pb-12">
    <div class="mb-8">
        <nav class="flex text-sm text-gray-500 mb-2">
            ...
            <span class="text-gray-900 font-medium">Edit Ruangan</span>
        </nav>
        <h1 class="text-2xl font-bold text-gray-900">Edit Data Ruangan</h1>
    </div>
        ...
        <form action="{{ route('admin.rooms.update', $room->id) }}" method="POST">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="bg-gray-50 rounded-xl p-4 text-sm text-gray-500 border border-gray-100 flex flex-col md:flex-row justify-between">
                    <div><span class="font-semibold text-gray-700">Terdaftar:</span> {{ $room->created_at->format('d M Y, H:i') }}</div>
                    <div><span class="font-semibold text-gray-700">Diperbarui:</span> {{ $room->updated_at->format('d M Y, H:i') }}</div>
                </div>
                @endif
            </div>
