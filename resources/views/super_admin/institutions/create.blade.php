{{-- resources/views/super_admin/institutions/create.blade.php --}}
@extends('layouts.super_admin')

@section('title', __('Tambah Instansi Baru'))
@section('header', __('Tambah Instansi'))
...
<div class="max-w-2xl mx-auto pb-10">
    ...
    <nav class="flex items-center gap-2 mb-6">
        ...
        <span class="text-sm font-semibold text-gray-900">Tambah Instansi Baru</span>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-1">
            ...
            <div>
                <h1 class="text-xl font-black text-gray-900 leading-tight">Tambah Instansi Baru</h1>
                <p class="text-xs text-gray-500 font-medium">Daftarkan sekolah baru ke dalam sistem</p>
            </div>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="form-field relative">
                        <textarea name="address" rows="3"
                            ...
                            placeholder="Jl. Raya No. 1, Kota, Provinsi">{{ old('address') }}</textarea>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-6">
            <div class="px-8 py-5 border-b border-gray-50 bg-gray-50/50 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Tentukan kondisi akses instansi saat pertama kali dibuat</p>
                </div>
            </div>
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3" id="statusCards">
                    ...
                    <div class="status-card {{ old('status', 'active') === 'active' ? 'selected-active' : '' }}" onclick="selectStatus('active', this)">
                    ...
                    <div class="status-card {{ old('status') === 'suspended' ? 'selected-suspended' : '' }}" onclick="selectStatus('suspended', this)">
                    ...
                    <div class="status-card {{ old('status') === 'maintenance' ? 'selected-maintenance' : '' }}" onclick="selectStatus('maintenance', this)">
                    ...
                    <div class="status-card {{ old('status') === 'expired' ? 'selected-expired' : '' }}" onclick="selectStatus('expired', this)">
