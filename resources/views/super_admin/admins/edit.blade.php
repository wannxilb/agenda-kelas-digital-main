{{-- resources/views/super_admin/admins/edit.blade.php --}}
@extends('layouts.super_admin')

@section('title', __('Edit Admin Sekolah'))
@section('header', __('Edit Admin Sekolah'))
...
<div class="max-w-2xl mx-auto pb-10">
    ...
    <nav class="flex items-center gap-2 mb-6">
        ...
        <span class="text-sm font-semibold text-gray-900">Edit Admin</span>
    </nav>
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-1">
            ...
            <div>
                <h1 class="text-xl font-black text-gray-900 leading-tight">Edit Admin Sekolah</h1>
                <p class="text-xs text-gray-500 font-medium">Perbarui informasi akun admin instansi</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-4">
            <div class="px-8 py-5 border-b border-gray-50 bg-gray-50/50 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Nama, email, dan pengaturan kata sandi</p>
                </div>
            </div>
            <div class="p-8 space-y-5">
                ...
                <div class="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                    <div class="flex gap-3">
                        ...
                        <p class="text-xs text-blue-700 leading-relaxed">Kosongkan kolom password di bawah ini jika Anda tidak ingin mengubah password admin saat ini.</p>
                    </div>
                </div>

                {{-- Password --}}
                <div>
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Password Baru <span class="text-gray-400 font-normal normal-case">(opsional)</span></label>
                    <div class="form-field relative">
                        <input type="password" name="password" id="pwdInput"
                            ...
                            placeholder="Biarkan kosong jika tidak diubah" oninput="checkStrength(this.value)">
                    ...
                    <div class="mt-2 space-y-1.5">
                        ...
                        <p class="text-xs text-gray-400" id="strengthLabel">Belum ada perubahan</p>
                    </div>
                ...
                {{-- Konfirmasi Password --}}
                <div>
                    <label class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Konfirmasi Password Baru</label>
                    <div class="form-field relative">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-6">
            <div class="px-8 py-5 border-b border-gray-50 bg-gray-50/50 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Pilih sekolah yang dikelola admin ini</p>
                </div>
            </div>
            <div class="p-8">
                ...
                <div class="form-field">
                    <select name="institution_id" required
                        ...
                        @foreach($institutions as $institution)
                            <option value="{{ $institution->id }}" {{ old('institution_id', $admin->institution_id) == $institution->id ? 'selected' : '' }}>
                                {{ $institution->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <p class="text-xs text-gray-400 mt-2">Pilih ulang jika ingin memindahkan admin ke instansi lain.</p>
            </div>
        </div>
...
function checkStrength(val) {
    ...
    if (!val) {
        ...
        label.textContent = 'Belum ada perubahan';
    ...
    const configs = [
        { w: '0%',   color: '#e5e7eb', text: 'Sangat Lemah' },
